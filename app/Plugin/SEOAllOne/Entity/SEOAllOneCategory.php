 ...
 * SEOAllOneCategory
 * 
 * @ORM\Table(name="plg_seoallone_category")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Plugin\SEOAllOne\Repository\SEOAllOneCategoryRepository")
 */
class SEOAllOneCategory extends \Eccube\Entity\AbstractEntity
{
    /**
     * @var int
     * 
     ...
     * @ORM\OneToOne(targetEntity="\Eccube\Entity\Category")
     * @ORM\JoinColumns({
