...
class CustomerRankEvent implements EventSubscriberInterface
{
    ...
    public function onTemplateAdminCustomer(TemplateEvent $event)
    {
        ...
        $js = '@CustomerRank/admin/Customer/customer_index.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateAdminCustomerEdit(TemplateEvent $event)
    {
        ...
        if(!is_null($Customer) && $Customer->getId()){
            $condition = $this->customerRankService->getCurrentCondition($Customer);
        }
        $parameters['CustomerCondition'] = $condition;
        $event->setParameters($parameters);

        $twig = '@CustomerRank/admin/Customer/customer_rank.twig';
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/Customer/customer_rank.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateAdminProductEdit(TemplateEvent $event)
    {
        ...
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/Product/customer_price.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateAdminProductClassEdit(TemplateEvent $event)
    {
        ...
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/Product/customer_price_class.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateAdminOrder(TemplateEvent $event)
    {
        ...
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/Order/order_index.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateAdminOrderEdit(TemplateEvent $event)
    {
        ...
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/Order/customer_rank.js';
        $event->addAsset($js);
    }
    ...
    public function onTemplateMailmagazineHistoryCondition(TemplateEvent $event)
    {
        ...
        $event->addSnippet($twig);
        $js = '@CustomerRank/admin/mailmagazine_history_condition_add.js';
        $event->addAsset($js);
