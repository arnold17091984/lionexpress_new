...
class ConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $arrDelivFree[CustomerRankConfig::DISABLED] = trans('customerrank.admin.setting.rank.choice.deliv_free.all');
        $arrDelivFree[CustomerRankConfig::ENABLED] = trans('customerrank.admin.setting.rank.choice.deliv_free.shipping');
        ...
        $builder
            ...
            ->add('deliv_free', Type\ChoiceType::class, [
                'label' => trans('customerrank.admin.setting.rank.label.deliv_free'),
                'required' => true,
                'expanded' => true,
                'multiple' => false,
                'choices' => array_flip($arrDelivFree),
            ])
        ;
